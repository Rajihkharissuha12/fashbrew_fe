    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          >
            <span className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
              Fashbreew
            </span>
          </motion.div>
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            disabled
            className="px-4 md:px-6 py-2 md:py-2.5 bg-gray-200 text-gray-400 rounded-full font-medium text-sm md:text-base cursor-not-allowed transition-all"
          >
            Coming Soon
          </motion.button>
        </div>
