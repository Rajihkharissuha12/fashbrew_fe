...
export default function InfluencerClient() {
  ...
  return redirect(`https://www.fashbreew.com/${username}/shop`);
    ...
    <>
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 py-12">
              <div className="max-w-4xl mx-auto px-4 text-center">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                  Discover amazing cafes around you. From cozy study spots to
                  trendy hangout places.
                </p>
        ...
        <p className="text-center text-gray-600 mt-8">
          &copy; 2025 Fashbrew. All rights reserved.
        </p>
      </div>
    </>
  );
